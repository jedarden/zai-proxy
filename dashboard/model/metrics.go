...
type MetricSnapshot struct {
	...
	EstimatedCostUSDInput      float64            `json:"estimated_cost_usd_input"`       // Estimated input cost (USD)
	EstimatedCostUSDOutput     float64            `json:"estimated_cost_usd_output"`      // Estimated output cost (USD)
	EstimatedCostUSDCacheRead  float64            `json:"estimated_cost_usd_cache_read"`  // Estimated cache-read cost (USD)
	EstimatedCostUSDCacheWrite float64            `json:"estimated_cost_usd_cache_write"` // Estimated cache-write cost (USD)
